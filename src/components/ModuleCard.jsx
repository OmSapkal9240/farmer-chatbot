...
export default function ModuleCard({ icon, title, desc, delay = 0 }) {
  return (
    <motion.div
      ...
      className="p-6 rounded-3xl bg-slate-800/50 backdrop-blur-lg border border-slate-700 hover:border-cyan-400 hover:scale-[1.02] hover:-translate-y-1 transition-all duration-300 ease-out"
    >
